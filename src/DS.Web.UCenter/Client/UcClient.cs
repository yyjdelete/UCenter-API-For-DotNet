...
namespace DS.Web.UCenter.Client
{
...
#endif
    {
        ...
        protected void addArray(IDictionary<string, string> args, string key, IEnumerable<int> value)
        {
            ...
            {
                args.Add(string.Format("{0}[{1}]", key, (index++).ToString()), v.ToString());
            }
        }
        ...
        public virtual async Task<UcUserRegister> UserRegisterAsync(string userName, string passWord, string email, int questionId = 0, string answer = "")
        {
            ...
            return new UcUserRegister(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionRegister));
        }
        ...
        public virtual async Task<UcUserLogin> UserLoginAsync(string userName, string passWord, LoginMethod loginMethod = LoginMethod.UserName, bool checkques = false, int questionId = 0, string answer = "")
        {
            ...
            return new UcUserLogin(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionLogin));
        }
        ...
        protected virtual async Task<UcUserInfo> userInfoAsync(string userName, InfoMethod infoMethod)
        {
            ...
            return new UcUserInfo(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionInfo));
        }
        ...
        public virtual async Task<UcUserEdit> UserEditAsync(string userName, string oldPw, string newPw, string email, bool ignoreOldPw = false, int questionId = 0, string answer = "")
        {
            ...
            return new UcUserEdit(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionEdit));
        }
        ...
        public virtual async Task<bool> UserDeleteAsync(params int[] uid)
        {
            var args = new Dictionary<string, string>();
            addArray(args, "uid", uid);
            return toBool(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionDelete));
        }
        ...
        public virtual async Task UserDeleteAvatarAsync(params int[] uid)
        {
            var args = new Dictionary<string, string>();
            addArray(args, "uid", uid);
            await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionDeleteAvatar);
        }
        ...
        public virtual async Task<string> UserSynloginAsync(int uid)
        {
            ...
            return await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionSynLogin);
        }
        ...
        public virtual async Task<UcUserCheckEmail> UserCheckEmailAsync(string email)
        {
            ...
            return new UcUserCheckEmail(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionCheckEmail));
        }
        ...
        public virtual async Task<bool> UserAddProtectedAsync(string admin, params string[] userName)
        {
            ...
            addArray(args, "username", userName);
            return toBool(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionAddProtected));
        }
        ...
        public virtual async Task<bool> UserDeleteProtectedAsync(string admin, params string[] userName)
        {
            ...
            addArray(args, "username", userName);
            return toBool(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionDeleteProtected));
        }
        ...
        public virtual async Task<UcUserMerge> UserMergeAsync(string oldUserName, string newUserName, int uid, string passWord, string email)
        {
            ...
            return new UcUserMerge(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionMerge));
        }
        ...
        public virtual async Task UserMergeRemoveAsync(string userName)
        {
            ...
            await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionMergeRemove);
        ...
        public virtual async Task<int> UserGetCreditAsync(int appId, int uid, int credit)
        {
            ...
            int.TryParse(await SendArgsAsync(args, UcUserModelName.ModelName, UcUserModelName.ActionGetCredit), out result);
            return result;
        }
        #endregion
        ...
        public virtual async Task<UcPmCheckNew> PmCheckNewAsync(int uid)
        {
            ...
            return new UcPmCheckNew(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionCheckNew));
        }
        ...
        /// <param name="sendMethod">msgto 参数类型</param>
        /// <returns></returns>
        private async Task<UcPmSend> pmSendAsync(int fromUid, string msgTo, string subject, string message, int replyPmId = 0, SendMethod sendMethod = SendMethod.Uid)
        {
            var args = new Dictionary<string, string>
                           {
                               {"fromuid", fromUid.ToString()},
            ...
            return new UcPmSend(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionSend));
        }
        ...
        public virtual async Task<int> PmDeleteAsync(int uid, PmDeleteFolder folder, params int[] pmIds)
        {
            ...
            addArray(args, "pmids", pmIds);
            return toInt(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionDelete));
        }
        ...
        public virtual async Task<int> PmDeleteAsync(int uid, params int[] toUids)
        {
            ...
            addArray(args, "touids", toUids);
            return toInt(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionDeleteUser));
        }
        ...
        public virtual async Task PmReadStatusAsync(int uid, IEnumerable<int> toUids, IEnumerable<int> pmIds, ReadStatus readStatus = ReadStatus.Readed)
        {
            ...
            addArray(args, "uids", toUids);
            addArray(args, "pmids", pmIds);
            await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionReadStatus);
        }
        ...
        public virtual async Task<UcPmList> PmListAsync(int uid, int page = 1, int pageSize = 10, PmReadFolder folder = PmReadFolder.NewBox, PmReadFilter filter = PmReadFilter.NewPm, int msgLen = 0)
        {
            ...
            return new UcPmList(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionList));
        }
        ...
        public virtual async Task<UcPmView> PmViewAsync(int uid, int pmId, int toUid = 0, DateRange dateRange = DateRange.Today)
        {
            ...
            return new UcPmView(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionView));
        }
        ...
        public virtual async Task<UcPm> PmViewNodeAsync(int uid, ViewType type = ViewType.Specified, int pmId = 0)
        {
            ...
            return new UcPm(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionViewNode));
        }
        ...
        public virtual async Task PmIgnoreAsync(int uid)
        {
            ...
            await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionIgnore);
        }
        ...
        public virtual async Task<UcPmBlacklsGet> PmBlacklsGetAsync(int uid)
        {
            ...
            return new UcPmBlacklsGet(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionBlacklsGet));
        }


        /// <summary>
        /// (异步)设置黑名单为禁止所有人（清空原数据）
        /// </summary>
        /// <param name="uid">Uid</param>
        /// <returns></returns>
        ...
        public virtual async Task<bool> PmBlacklsSetAsync(int uid, params string[] userName)
        {
            ...
            return toBool(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionBlacklsSet));
        }
        ...
        public virtual async Task<bool> PmBlacklsAddAsync(int uid, params string[] userName)
        {
            ...
            addArray(args, "username", userName);
            return toBool(await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionBlacklsAdd));
        }
        ...
        public virtual async Task PmBlacklsDeleteAsync(int uid, params string[] userName)
        {
            ...
            addArray(args, "username", userName);
            await SendArgsAsync(args, UcPmModelName.ModelName, UcPmModelName.ActionBlacklsDelete);
        }
        #endregion
        ...
        public virtual async Task<bool> FriendAddAsync(int uid, int friendId, string comment = "")
        {
            ...
            return toBool(await SendArgsAsync(args, UcFriendModelName.ModelName, UcFriendModelName.ActionAdd));
        }
        ...
        public virtual async Task<bool> FriendDeleteAsync(int uid, params int[] friendIds)
        {
            ...
            addArray(args, "friendids", friendIds);
            return toBool(await SendArgsAsync(args, UcFriendModelName.ModelName, UcFriendModelName.ActionDelete));
        }
        ...
        public virtual async Task<int> FriendTotalNumAsync(int uid, FriendDirection direction = FriendDirection.All)
        {
            ...
            return toInt(await SendArgsAsync(args, UcFriendModelName.ModelName, UcFriendModelName.ActionTotalNum));
        }
        ...
        public virtual async Task<UcFriends> FriendListAsync(int uid, int page = 1, int pageSize = 10, int totalNum = 10, FriendDirection direction = FriendDirection.All)
        {
            ...
            return new UcFriends(await SendArgsAsync(args, UcFriendModelName.ModelName, UcFriendModelName.ActionList));
        }
        #endregion
        ...
        public virtual async Task<bool> CreditExchangeRequestAsync(int uid, int from, int to, int toAppId, int amount)
        {
            ...
            return toBool(await SendArgsAsync(args, UcCreditModelName.ModelName, UcCreditModelName.ActionExchangeRequest));
        }
        #endregion
        ...
        public virtual async Task<bool> AvatarCheckAsync(int uid, AvatarSize size = AvatarSize.Middle, AvatarType type = AvatarType.Virtual)
        {
            ...
            return toBool(await SendGetAsync(UcConfig.UcApi + "avatar.php", args));
        }
        ...
        public virtual async Task<UcTags> TagGetAsync(string tagName, IEnumerable<KeyValuePair<string, string>> number)
        {
            ...
            return new UcTags(await SendArgsAsync(args, UcTagModelName.ModelName, UcTagModelName.ActionGet));
        }
        #endregion
        ...
        public virtual async Task<int> FeedAddAsync(FeedIcon icon, int uid, string userName, string titleTemplate, string titleData, string bodyTemplate, string bodyData, string bodyGeneral, string targetIds, params string[] images)
        {
            ...
            return toInt(await SendArgsAsync(args, UcFeedModelName.ModelName, UcFeedModelName.ActionAdd));
        }
        ...
        public virtual async Task<UcFeeds> FeedGetAsync(int limit)
        {
            ...
            return new UcFeeds(await SendArgsAsync(args, UcFeedModelName.ModelName, UcFeedModelName.ActionGet));
        }
        #endregion
        ...
        public virtual async Task<UcMailQueue> MailQueueAsync(string subject, string message, string fromMail, string charset, bool htmlOn, int level, int[] uids, string[] emails)
        {
            ...
            return new UcMailQueue(await SendArgsAsync(args, UcMailModelName.ModelName, UcMailModelName.ActionAdd));
        }
        #endregion
#endif
        #endregion
